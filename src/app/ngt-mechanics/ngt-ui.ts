...
export class UIEvents extends Category {
	...
	UIEventsCarousel() {
		...
		// abc
		// this.ia('[Nav] goTo', (evp) => { // /OK
		// 	return { ...evp.payload  };
		// })
		// 	.evs([
		// 		{ type:'[UI Event] click', ctx: { w:'w/carousel', ui:'link:slideLink' } }
		// 	])
		// this.ia('[UI Show/Hide] show', (evp) => {
		// 	return { ...evp.payload  };;
		// })
		// 	.evs([
		// 		{ type:'[UI Event] click', ctx: { w:'a/appCarousel', ui:'button:editCarousel' } },
		// 		{ type:'[UI Event] click', ctx: { w:'w/adminPanel', ui:'button:close' } },
		// 		{ type:'[UI Event] click', ctx: { w:'w/adminPanel', ui:'button:save' } }
		// 	])
		// this.ia('[CRUD] create slide/tile', (evp) => {
		// 	return { ...evp.payload  };;
		// })
		// 	.evs([
		// 		{ type:'[UI Event] click', ctx: { w:'a/tilesEditor', ui:'button:createSlide' } }
		// 	])
		// this.ia('[CRUD] delete slide/tile', (evp) => {
		// 	return { ...evp.payload  };;
		// })
		// 	.evs([
		// 		{ type:'[UI Event] click', ctx: { w:'w/tileItem', ui:'button:deleteSlide' } },
		// 		{ type:'[UI Event] click', ctx: { w:'w/tileItem', ui:'dropdownMenu:moreActions', action: 'delete' } }
		// 	])
		// this.ia('[UI Open/Close] open', (evp) => {
		// 	return { ...evp.payload  };;
		// })
		// 	.evs([
		// 		{ type:'[UI Event]', ctx: { w:'w/tileItem', ui:'dropdownMenu:moreActions', action: 'moreOptions' } }
		// 	])
	}

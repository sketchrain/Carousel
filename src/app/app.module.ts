...
// flow
import { TInjector1, MSignal, MActions, MInteractions, MStates, MSelectors, MUIEvents, DataModel3, Managers } from '../flow/core/fl-core';
...
import { 
  ...
  // < CarouselApp
  WCarousel, WAdminPanel, WTilesEditor, WTileItem
